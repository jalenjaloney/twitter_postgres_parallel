...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/jalenjaloney/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/jalenjaloney/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/jalenjaloney/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/jalenjaloney/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/jalenjaloney/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/jalenjaloney/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 3m40.345s                 | 24.35 s                  | 
| `pg_normalized_batch`  | 1m32.434s                 | 12.68 s                  | 
| `pg_denormalized`      | 14.439s                   | 3.02 s                   | 
